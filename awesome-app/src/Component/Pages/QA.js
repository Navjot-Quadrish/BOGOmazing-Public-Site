      ...
      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div id="Q-A" className="about-area">
          ...
          <p >$29.95</p>
           ...
           <p>Any item typically $15 or more that are Entrees excluding A la Carte Selections, Appetizers and Desserts. Other items may be included at the discretion of each individual participating restaurant. You can access complete BOGO menus through the BOGOmazing App as well as at WWW.BOGOmazing.COM. When redeeming, you only need to purchase 1 beverage per person and 1 appetizer per 2 people (up to 6 people) to receive the 2nd item free from the 2nd Item FREE list of selection on the app.</p>
